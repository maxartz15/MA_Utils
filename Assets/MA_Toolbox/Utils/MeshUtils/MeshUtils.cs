...
namespace MA_Toolbox.Utils.Editor
{
	...
	{
		public static void SaveMeshAsset(Mesh mesh, string savePath, string meshName = "")
		{
		...
		public static Mesh ReMapUV(this Mesh mesh, Vector2 atlasSize, Vector2 textureSize, Vector2 texturePosition, int uvChannel = 0)
		{
			/*
			 0     1
			512 x 512
		...
		public static Mesh UVReMap(this Mesh mesh, Vector2 atlasSize, Rect textureRect, int uvChannel = 0, bool flipY = true, bool wrap = true)
		{	
			//Get UV's
			List<Vector2> uvs = new List<Vector2>();
			mesh.GetUVs(uvChannel, uvs);
